...
const Hills = () => React.createElement("svg", {
  xmlns: "http://www.w3.org/2000/svg", width: "880px", height: "290px", className: "hill",
  ...
  React.createElement("svg", {
    className: "tree", width: "100", height: "120",
  ...
  React.createElement("svg", {
    ...
    [...Array(1000).keys()].map((star) =>
      React.createElement("circle", {
        fill: "#fff", cx: randRange(0, 600), cy: randRange(0, 600), r: randRange(0.05, 1), style: {
