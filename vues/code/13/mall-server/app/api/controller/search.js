...
module.exports = class extends Base {
  indexAction() {
    ...
    return _asyncToGenerator(function* () {
      ...
      const historyKeywordList = yield _this.model('search_history').distinct('keyword').where({ user_id: _this.getLoginUserId() }).limit(10).getField('keyword');
  ...
  clearhistoryAction() {
    ...
    return _asyncToGenerator(function* () {
      yield _this3.model('search_history').where({ user_id: _this3.getLoginUserId() }).delete();
